import unittest
from data_processor3 import (
    parse_numbers,
    process_numbers,
    process_string,
    count_vowels,
    is_palindrome,
    remove_duplicates   # новая функция
)
...
class TestDataProcessor(unittest.TestCase):
    ...
    def test_count_vowels(self):
        ...
        self.assertEqual(count_vowels("HELLO"), 2)      # E, O
        self.assertEqual(count_vowels("xyz"), 0)        # нет гласных (y не считается)
        self.assertEqual(count_vowels(""), 0)
        self.assertEqual(count_vowels("Python"), 1)     # только 'o' (y не гласная)
    ...
    def test_is_palindrome_true(self):
        ...
        self.assertTrue(is_palindrome(""))          # пустая строка — палиндром
    ...
    def test_remove_duplicates_all_same(self):
        self.assertEqual(remove_duplicates([3, 3, 3, 3]), [3])
